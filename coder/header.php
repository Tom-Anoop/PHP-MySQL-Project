                    ...
                    <div class="header d-lg-flex justify-content-between align-items-center">
                        <div class="header-section">
                            <h1>
                                <a class="navbar-brand logo editContent" href="index.html">
                                    <span class="fa fa-angellist"></span> Virgin Startup
                                </a>
                            </h1>
                        </div>
                        <div class="nav_section">
                            <nav>
                                ...
                                <ul class="menu">
                                    <li ><a href="coderhome.php">Home</a></li>
                                    <li><a href="coderrequest.php">Request</a></li>
                                    <li><a href="coderwork.php">Work</a></li>
